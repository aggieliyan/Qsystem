...
class category(models.Model):
	...
	redmine_proid = models.CharField(u'redmine项目id', max_length=30)
...
class testcase(models.Model):
	...
	action = models.CharField(u'输入/动作', max_length=300)
	output = models.CharField(u'期望输出', max_length=300)
...
class result(models.Model):
	...
	executor = models.CharField(u'执行人', max_length=50, blank=True, null=True)
