...
#    url('^register', 'project.views.register',name="register"),i
    ...
    url(r'^detail/(\d+)/#feedback', project.views.detail, name="\'feedback\'"),
    url(r'^iwant/([^/]+)/(\d+)/(\d+)/$', project.views.signup_project),
   ...
   #sourcemanage
    ...
    ('^detail/(\d+)/$', detail),
    ('^score/(\d+)/$', project.views.score),
    ('^scoreuser/(\d+)/(\d+)/$', project.views.scoreuser),
    ('^feedback/$', project_feedback),
    ('^comment/$', feedback_comment),
    ('^myscore/$', project.views.myscore),
    ('^viewscore/(\d+)/(a|c)/$', project.views.myscore),
    ('^scorelist/$', project.views.scorelist),
