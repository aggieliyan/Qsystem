...
def initdata(request):
    ...
    module1.save()
    module2 = module(id=2,module_name='内部管理',isactived=1)
    module2.save()
    module3 = module(id=3,module_name='机构后台',isactived=1)
    module3.save()
    module4 = module(id=4,module_name='机构前台',isactived=1)
    module4.save()
    module5 = module(id=5,module_name='AS平台(AS运营类)',isactived=1)
    module5.save()
    module6 = module(id=6,module_name='客户端产品',isactived=1)
    module6.save()
    module7 = module(id=7,module_name='考试系统',isactived=1)
    module7.save()
    module8 = module(id=8,module_name='项目组产品',isactived=1)
    module8.save()
